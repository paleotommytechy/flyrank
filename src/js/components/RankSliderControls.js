    ...
    <div class="ranker-section">
      ...
      <div class="sliders-grid">
        <div class="slider-card">
          ...
          <input type="range" id="slider-price" min="0" max="100" value="${weights.price}" />
        </div>
        ...
        <div class="slider-card">
          ...
          <input type="range" id="slider-duration" min="0" max="100" value="${weights.duration}" />
        </div>
        ...
        <div class="slider-card">
          ...
          <input type="range" id="slider-co2" min="0" max="100" value="${weights.co2}" />
        </div>
        ...
        <div class="slider-card">
          ...
          <input type="range" id="slider-layovers" min="0" max="100" value="${weights.layovers}" />
        </div>
        ...
        <div class="slider-card">
          ...
          <input type="range" id="slider-rating" min="0" max="100" value="${weights.rating}" />
        </div>
      </div>
    </div>
  `;
