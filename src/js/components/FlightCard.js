  ...
  card.innerHTML = `
    ...
    <div class="flight-pricing">
      ...
      <div class="card-actions">
        <button type="button" class="btn btn-secondary btn-icon-only toggle-bookmark" title="Bookmark flight" aria-label="Bookmark flight ${flight.airline} ${flight.flightNumber}">
          ${isBookmarked ? '❤️' : '🤍'}
        </button>
        <button type="button" class="btn btn-secondary toggle-compare" aria-label="Compare flight ${flight.airline} ${flight.flightNumber}">
          <input type="checkbox" ${isCompared ? 'checked' : ''} pointer-events="none" aria-hidden="true" />
          <span>Compare</span>
        </button>
      </div>
    </div>
