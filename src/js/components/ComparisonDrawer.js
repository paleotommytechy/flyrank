...
export function renderComparisonDrawer(containerId) {
  ...
  container.innerHTML = `
    ...
    <div id="compare-modal-backdrop" class="modal-backdrop" role="dialog" aria-modal="true" aria-labelledby="compare-modal-title">
      <div class="modal-content">
        <div class="modal-header">
          <h2 id="compare-modal-title">Side-by-Side Flight Comparison</h2>
          <button type="button" id="btn-close-compare-modal" class="modal-close" aria-label="Close side-by-side flight comparison modal">✖</button>
        </div>
